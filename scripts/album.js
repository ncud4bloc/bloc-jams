...
// togglePlayFromPlayerBar is an Assignment-20 addition

var togglePlayFromPlayerBar = function() {                                  
    if (currentSoundFile.isPaused()) {                                  
        $('.song-item-number[data-song-number="' + currentlyPlayingSongNumber + '"]').html(pauseButtonTemplate);                              //Ncc Assignment-20 addition
...
// Album button templates
 ...
 var $playPauseButton = $('.main-controls .play-pause');            //Ncc Assignment-20 addition
 
 $(document).ready(function() {
     setCurrentAlbum(albumPicasso);
     $previousButton.click(previousSong);
     $nextButton.click(nextSong);
     $playPauseButton.click(togglePlayFromPlayerBar);               //Ncc Assignment-20 addition
 });